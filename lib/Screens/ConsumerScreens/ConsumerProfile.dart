...
class _ConsumerProfileState extends State<ConsumerProfile> {
  ...
  void updateAddress(var address) {
    var oc = consumer;
    oc['consumer_address'] = address;
    setState(() {
      consumer = oc;
    });
  }
                      ...
                      Center(
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              border:
                                  Border.all(width: 0.75, color: Colors.green)),
                      ...
                      Center(
                        child: Container(
                          ...
                          child: Text(
                            ...
                            style: TextStyle(
                                color: Colors.black54, fontSize: 24.555),
                            maxLines: 1,
                          ),
                        ),
                      ),
                        ...
                        child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Text(
                                'Manage My Address',
                                style: TextStyle(
                                    fontSize: 22.5, color: Colors.green),
                              ),
                            )),
                      )
                    ],
