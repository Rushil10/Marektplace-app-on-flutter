...
String convertToJson(
    var email, var password, var contact, var address, var name, var image) {
  var res = {};
  res["consumer_email"] = email;
  res["consumer_password"] = password;
...
String convertAddressToJson(var address, var state, var pincode, var longitude,
    var latitude, var name) {
  var res = {};
  res['address'] = address;
  res['state'] = state;
  res['pincode'] = pincode;
...
String convertProductDetailsToJson(
    var name, var price, var qty, var imageUrl, var type) {
  var res = {};
...
String convertShopSignupDetailsToJson(
    var email,
    var password,
    var shopName,
    var ownerName,
...
String updateProductJson(
    ...
    var increase_quantity,
    var decrease_quantity,
    var product_image) {
  var res = {};
  //res["shop_id"]=shop_id;
